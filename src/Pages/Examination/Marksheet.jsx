...
import { getAllClassApi, getAllMarksheetDataAPI, getAllPromotedStudentsDataAPI, getExamCategoryDataApi } from '../../Utils/Apis';
...
const Marksheet = () => {
    ...
    console.log(allSubjectData, 'all subjects')
    console.log(MarksheetData[0].subjects, 'all marksheet subjects')
                                            ...
                                            <table className="table align-middle table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        {MarksheetData[0].subjects.map((subjectsmarks) => (
                                                    ...
                                                    {MarksheetData.map((item, index) => (
                                                        <tr key={item.studentId} className='my-bg-color align-middle'>
                                                            ...
                                                            {(item.subjects).map((subjectsmarks) => (
                                                                <td className='greyText font14 text-center'>{subjectsmarks.marks === null ? '-' : <> {subjectsmarks.marks} | {subjectsmarks.grade} </> }</td>
                                                            ))}
...
//             setAllSectionData(selectedClass.section || []);
//             setAllSubjectData(selectedClass.subjects || []);
//             console.log(selectedClass.subjects, 'subjects ')
//         } else {
//             setAllSectionData([]);
//             setAllSubjectData([]);
//         }
...
//             setloaderState(true);
//             const search = '';
//             var response = await getAllMarksheetDataAPI(sectionId, classId, examCategorySelect, search, pageNo, pageSize);
//             console.log(response, 'marksheet data here')
//             if (response?.status === 200) {
//                 if (response?.data?.status === 'success') {
//                     setloaderState(false);
...
//                                                                 <td className='greyText font14'><h3>{item.studentName}</h3></td>
//                                                                 {(item.subjects).map((subjectsmarks) => (
//                                                                     <td className='greyText font14'><h3>{subjectsmarks.studentName}</h3></td>
//                                                                 ))}

//                                                                 {/* {allSubjectData?.map((option, index) => (
//                                                                     <td className='greyText font14' key={option.subjectId}>
//                                                                         {(item.subjects).map((subject_Name) => (
//                                                                             option.subjectName[index] === subject_Name.subjectName ? <span>{subject_Name.marks}</span> : ''
//                                                                         ))}
//                                                                     </td>
//                                                                 ))} */}
