    ...
    <div className="container-fluid main-body p-3">
     ...
     <div className='me-2 search-responsive'>
         <div className="input-group mb-3 ">
             ...
             <span className="input-group-text button-bg-color button-color heading-14 font-color " style={{cursor:'pointer',height:"34px"}} id="basic-addon2" onClick={''}>Search</span>
         </div>
     </div>
      ...
      <thead className=''>
        ...
        <tbody className='heading-14 align-middle greyTextColor greyText'>
        {
            AssignAllData.map((item, index) => (
              ...
              {/* <td className=' greyText pe-0'>{item}</td> */}
            {/* //   <td className=' greyText pe-0'>{item.numberOfLeaves}</td> */}
              <td className=' greyText  pe-0' >
