...
const Item_category = () => {
  ...
  const MyItemCategoryGetAllApi = async () => {
    ...
    try {
      const response = await ItemCategoryGetAllApi();
      console.log('my Item Category all dataaaaa', response);
      if (response?.status === 200) {
        toast.success(response?.data?.message)
        setItemCategoryData(response?.data?.itemCategory)
        setLoader(false)
      } else {
                    ...
                    <div className="row p-3">
                        ...
                        <div className="col-lg-6 col-md-6 col-sm-12  ">
                            <div className="mb-3" >
                                ...
                                <input type="text" className="form-control form-focus form-control-sm   heading-14" value={active === true ? '' : itemCategory} onChange={(e) => setItemCategory(e.target.value)} style={{ marginTop: '-4px' }} id="exampleFormControlInput1" placeholder="Enter Category " />
                            </div>
                        </div>
                        <div className="col-lg-6 col-md-6 col-sm-12  ">
                            <div className="mb-3" >
