...
const Conta_reimburse = ({data}) => {
  ...
  const [loader, setLoader] = useState(false)
    ...
    const ContactDataApi = async () => {
      ...
      setLoader(true)
      try {
          const response = await UserReimbirmntGetAllApi(staffId,formData);
      ...
      <div className="container-fluid px-0 mt-3">
        ...
        <div className="row px-3">
          ...
          <div className="mb-3  pt- for-media-margin">
              ...
              <input type="text" className="form-control form-focus-input form-control-sm heading-14 grey-input-text-color input-border-color" value={status === "success" ? '' : reimbursemntt} onChange={(e) => setReimbursemntt(e.target.value)} style={{ borderRadius: '5px', marginTop: '-5px' }} id="exampleFormControlInput12" placeholder="Enter Title" />
            </div>
          ...
          <div className="mb-3  pt- for-media-margin">
              ...
              <input type="text" className="form-control form-focus-input form-control-sm heading-14 grey-input-text-color input-border-color" value={status === "success" ? '' : AmountOP} onChange={(e) => setAmountOP(e.target.value)} style={{ borderRadius: '5px', marginTop: '-5px' }} id="exampleFormControlInput12" placeholder="Enter Title" />
            </div>
