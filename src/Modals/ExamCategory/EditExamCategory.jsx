                    ...
                    {AddExamCategory
                        ?
                            <>
                                <form className='p-3'>
                                    <div class="mb-3">
                                        <label for="exampleInputEmail1" class="form-label font14">Name</label>
                                        <input type="text" id="exampleInputEmail1" className='form-control font14' placeholder='Class Test'/>
                                    </div>
                                    <p className='text-center p-3'>
                                        <button className='btn updateButtons text-white' onClick={() => AddBtnClicked()}>Update</button>
...
export default EditExamCategory